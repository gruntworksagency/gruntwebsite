export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-orange-400 fill-orange-300",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-orange-400 fill-neutral-300 hs-tab-active:fill-orange-300 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-orange-400  hs-tab-active:text-orange-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 shrink-0 text-orange-400 text-orange-300",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text-red-400 group-hover:text-red-400",
      },
    ],
  ...
  xFooter: {
    ...
    class: "h-4 w-4 shrink-0 fill-current text-neutral-700 ",
    viewBox: "0 0 24 24",
    fill: "currentColor",
    title: "Twitter",
  },
